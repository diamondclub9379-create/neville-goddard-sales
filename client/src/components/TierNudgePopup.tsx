 ...
 */
export function TierNudgePopup({ isOpen, onClose, currentQuantity, onContinueShopping }: TierNudgePopupProps) {
...
// Backward-compat alias so existing imports of BundleUpsellPopup still work
export { TierNudgePopup as BundleUpsellPopup };
